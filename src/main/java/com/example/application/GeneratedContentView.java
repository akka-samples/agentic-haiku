...
public class GeneratedContentView extends View {
  ...
  public record GeneratedContent(Long generateAt, String collectionId, String prompt, Optional<Haiku> haiku, Optional<Image> image){}
  ...
  public static class ImagesUpdater extends TableUpdater<GeneratedContent> {
    ...
    public Effect<GeneratedContent> onChange(ContentGeneration contentGeneration) {
      if (contentGeneration.haiku().isPresent() || contentGeneration.image().isPresent()) {
        var content = new GeneratedContent(contentGeneration.generatedAt(), contentGeneration.collectionId(), contentGeneration.prompt(), contentGeneration.haiku(), contentGeneration.image());
