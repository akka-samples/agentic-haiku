...
public class GeneratedContentView extends View {
  ...
  public record GeneratedContent(Long generateAt, String inputId, String prompt, Optional<Haiku> haiku, Optional<Image> image){}
  ...
  public static class ImagesUpdater extends TableUpdater<GeneratedContent> {
    ...
    public Effect<GeneratedContent> onChange(ContentGeneration contentGeneration) {
      if (contentGeneration.haiku().isPresent() || contentGeneration.image().isPresent()) {
        var content = new GeneratedContent(contentGeneration.generatedAt(), contentGeneration.inputId(), contentGeneration.prompt(), contentGeneration.haiku(), contentGeneration.image());
